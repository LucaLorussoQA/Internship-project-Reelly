...
class HomePage(Page):
    ...
    OFF_PLAN_MOBILE_TAB = (By.XPATH, "//div[text()='Off-plan']")  # MOBILE LOCATOR
    ...
    SECONDARY_MOBILE_TAB= (By.XPATH, "//button[text()='Secondary']") # mobile
    ...
    BACK_OFF_PLAN_MOBILE_TAB = (By.XPATH, "//div[text()='Back']") # MOBILE LOCATOR
